...
if [ ! -f "com.bilibili.AzurLane.apk" ]; then
    ...
    wget https://github.com/fireflych/AzurLaneBiliBili-Perseus/releases/download/9.6.11/blhx_9.6.11_0814_1_20250819_110937_2a0c3.apk -O com.bilibili.AzurLane.apk
    echo "apk downloaded !"
